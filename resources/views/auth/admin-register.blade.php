                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form action="{{ route('store-admin') }}" method="post">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" name="nom_user" class="form-control" id="floatingText"
                                    placeholder="jhondoe">
                            ...
                            @enderror
                            <div class="form-floating mb-3">
                                <input type="text" name="phrase_secrete" class="form-control" id="floatingText"
                                    placeholder="jhondoe">
                            ...
                            @enderror
                            <div class="form-floating mb-3">
                                <input type="text" name="login" class="form-control" id="floatingText"
                                    placeholder="jhondoe">
                            ...
                            @enderror
                            <div class="form-floating mb-3">
                                <input type="text" name="telephone" class="form-control" id="floatingText"
                                    placeholder="jhondoe">
                                <label for="floatingText">Téléphone</label>
                            </div>
                            <button type="submit" class="btn btn-primary py-3 w-100 mb-4">S'inscrire</button>
                            <p class="text-center mb-0">Vous avez déjà un compte? <a
                                    href="{{ route('login-form') }}">S'identifier</a></p>
                        </form>
                    </div>
                </div>
            </div>
